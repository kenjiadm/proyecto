...
<div>
    <div class="m-4 p-4">
        ...
        @if ($respuestas['respuesta2'] === 'si')
        <div class="mb-3">
            <label class="form-label">1.1) ¿Qué tipo de violencia física ha recibido?</label>
        ...
        @endif
        <div class="mb-3">
            <label class="form-label">2) ¿Conoce de algún acto de violencia física contra otra persona?</label>
            <div class="form-check">
        ...
        @if ($respuestas['respuesta1'] === 'si')
        <div class="mb-3">
            <label class="form-label">2.2) ¿Qué tipo de violencia física ha presenciado?</label>
            <div class="form-text text-danger">@error('respuesta4') {{$message}} @enderror</div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="respuesta4[]" wire:model.lazy="respuesta4"
                    value="Golpes" id="rp4_opcion1">
        ...
        @endif
        <div class="mb-3">
            <label class="form-label">3) ¿Ha sufrido USTED violencia psicologica?</label>
            <div class="form-check">
        ...
        <div class="mb-3">
            <label class="form-label">3.1) ¿Que tipo de violencia psicológica ha recibido?</label>
        ...
        @endif
        <div class="mb-3">
            <label class="form-label">4) ¿Conoce o ha sido testigo de un acto de violencia psicológica contra otra persona?</label>
            <div class="form-check">
        ...
        @if ($respuestas['respuesta5'] === 'si')
        <div class="mb-3">
            <label class="form-label">4.1) Tengo conocimiento de actos de violencia psicológica en contra de otra persona en mí condición de:</label>
            <div class="form-check">
        ...
        <div class="mb-3">
            <label class="form-label">4.1.1) Precisar cargo y centro de salud en el que se desempeña</label>
            <div class="col-10 ">
                <div class="form-group row my-2 align-items-center">
        ...
        <div class="mb-3">
            <label class="form-label">4.1.1) Precisar cargo y centro educativo en el que se desempeña</label>
            <div class="col-10 ">
                <div class="form-group row my-2 align-items-center">
        ...
        <div class="mb-3">
            <label class="form-label">4.1.1) Precisar la relación de parentesco que mantiene con la víctima, que le
                permitió tomar
                conocimiento de los hechos que denuncia:</label>
            <div class="col-10 ">
                <div class="form-group row my-2 align-items-center">
        ...
        <div class="mb-3">
            <label class="form-label">4.1.1) Precisar la relación que mantiene con la víctima, que le permitió tomar
                conocimiento de los hechos que denuncia:</label>
            <div class="col-10 ">
                <div class="form-group row my-2 align-items-center">
        ...
        @if ($respuestas['respuesta5'] === 'si')
        <div class="mb-3">
            <label class="form-label">4.2) ¿Que tipo de violencia psicológica ha presenciado y/o ha tomado conocimiento?</label>
            <div class="form-text text-danger">@error('respuesta7') {{$message}} @enderror</div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="respuesta7[]" wire:model.lazy="respuesta7"
                    value="Insultos" id="rp7_opcion1">
        ...
        <div class="mb-3">
            <label class="form-label">5) Puede precisar la fecha de la agresión o la fecha aproximada en la que se
                produjeron
        ...
        <div class="mb-3">
            <label class="form-label">6) Mencione los nombres y apellidos de la persona o personas agraviadas. El campo
                de edad puede quedar en blanco.
        ...
        <div class="mb-3">
            <label class="form-label">7) ¿Conoce los nombres y apellidos de la persona o personas agresoras?</label>
            <div class="form-check">
        ...
        <div class="mb-3">
            <label class="form-label">7.1) Precise los nombres y apellidos de la persona o personas agresoras</label>
            <div class="col-10 ">
                {{$agresores}}
            </div>
        </div>
        @endif
        <div class="mb-3">
            <label class="form-label">8) ¿Qué relación tiene la persona agraviada con la persona agresora?</label>
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="respuesta10" wire:model.lazy="respuesta10"
                    value="desconoce" id="rp10_opcion14">
                <label class="form-check-label" for="rp10_opcion14">
                    Desconoce
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="respuesta10" wire:model.lazy="respuesta10"
                    value="otro" id="rp10_opcion15">
                <label class="form-check-label d-flex" for="rp10_opcion15">
                    Otro
        ...
        <div class="mb-3">
            <label class="form-label">9) Precise en qué lugar ocurrieron los hechos.</label>
            <div class="col-10 ">
                {{$lugares}}
            </div>
        </div>
