...
<div class="container">
    <form class="m-4 p-4" action="{{url('denuncia3', $denunciante->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <label class="form-label">¿Ha tomado conocimiento de un acto de violencia fisica a otra persona?</label>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="respuesta1" value="si" id="rp1_opcion1">
                    <label class="form-check-label" for="rp1_opcion1">
                        Si
                    </label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="respuesta1" value="no" id="rp1_opcion2" checked>
        ...
        <div class="mb-3">
          <label class="form-label">He tomado conocimiento de actos de violencia física en mi condición de:</label>
                  <div class="form-check">
                  <input class="form-check-input" type="radio" name="respuesta1.1" value="a" id="rp1.1_opcion1">
                  <label class="form-check-label" for="rp1.1_opcion1">
                      Personal de Salud
                  </label>
                  </div>
                  <div class="form-check">
                  <input class="form-check-input" type="radio" name="respuesta1.1" value="b" id="rp1.1_opcion2">
                  <label class="form-check-label" for="rp1.1_opcion2">
                      Personal de Educación
                  </label>
                  </div>
                  <div class="form-check">
                  <input class="form-check-input" type="radio" name="respuesta1.1" value="c" id="rp1.1_opcion3">
        ...
        <div class="mb-3">
          <label class="form-label">Precisar cargo y centro de salud en el que se desempeña</label>
        ...
        <div class="mb-3">
          <label class="form-label">Precisar cargo y centro educativo en el que se desempeña</label>
          <div class="col-sm-10 col-lg-5">
              <div class="form-group row my-2 align-items-center">
        ...
        <div class="mb-3">
          <label class="form-label">Precisar la relación que mantiene con la víctima, que le permitió tomar conocimiento de los hechos que denuncia:</label>
          <div class="col-sm-10 col-lg-5">
              <div class="form-group row my-2 align-items-center">
        ...
        <div class="mb-3">
            <label class="form-label">¿Ha sufrido USTED violencia fisica?</label>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="respuesta2" value="no" id="rp2_opcion2" checked>
        ...
        <div class="mb-3">
            <label class="form-label">¿Qué tipo de violencia física ha recibido y/o presenciado?</label>
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="respuesta4[]" value="Golpes, quemaduras, etc." id="rp4_opcion1">
                    <label class="form-check-label" for="rp4_opcion1">
                        Golpes, quemaduras, etc.
                    </label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="respuesta4[]" value="violación o abuso sexual" id="rp4_opcion2">
                    ...
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="respuesta4[]" value="prostitución forzada" id="rp4_opcion5">
        ...
        <div class="mb-3">
            <label class="form-label">¿Ha tomado conocimiento de un acto de violencia psicologica a otra persona?</label>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="respuesta5" value="si" id="rp5_opcion1">
                    <label class="form-check-label" for="rp5_opcion1">
                        Si
                    </label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="respuesta5" value="no" id="rp5_opcion2" checked>
        ...
        <div class="mb-3">
          <label class="form-label">He tomado conocimiento de actos de violencia psicologica en mi condición de:</label>
                  <div class="form-check">
                  <input class="form-check-input" type="radio" name="respuesta5.1" value="a" id="rp5.1_opcion1">
                  <label class="form-check-label" for="rp5.1_opcion1">
                      Personal de Salud
                  </label>
                  </div>
                  <div class="form-check">
                  <input class="form-check-input" type="radio" name="respuesta5.1" value="b" id="rp5.1_opcion2">
                  <label class="form-check-label" for="rp5.1_opcion2">
                      Personal de Educación
                  </label>
                  </div>
                  <div class="form-check">
                  <input class="form-check-input" type="radio" name="respuesta5.1" value="c" id="rp5.1_opcion3">
        ...
        <div class="mb-3">
            <label class="form-label">¿Ha sufrido USTED violencia psicologica?</label>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="respuesta6" value="no" id="rp6_opcion2" checked>
        ...
        <div class="mb-3">
            <label class="form-label">¿Qué tipo de violencia psicológica ha recibido y/o presenciado?</label>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="respuesta7[]" value="ataques a la autoestima" id="rp7_opcion2">
                    ...
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="respuesta7[]" value="Coacción: Obligar a hacer algo bajo amenaza." id="rp7_opcion4">
                    <label class="form-check-label" for="rp7_opcion4">
                        Coacción: Obligar a hacer algo bajo amenaza.
                    </label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="respuesta7[]" value="Privación de la libertad" id="rp7_opcion5">
                    <label class="form-check-label" for="rp7_opcion5">
                        Privación de la libertad
                    </label>
                    </div>
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="respuesta7[]" value="Económica(Control de su dinero, no recibe pensión de alimentos, etc)" id="rp7_opcion6">
        ...
        <div class="mb-3">
          <label class="form-label">Precise el nombre, apellido y edad de la persona agraviada (De ser USTED complete con sus datos)</label>
          <div class="col-sm-10 col-lg-5">
              <div class="form-group row my-2 align-items-center">
        ...
        <div class="mb-3">
          <label class="form-label">Precise el nombre, apellido y edad de la persona agresora</label>
          <div class="col-sm-10 col-lg-5">
              <div class="form-group row my-2 align-items-center">
        ...
        <div class="mb-3">
            <label class="form-label">¿Qué relación tiene la persona agraviada con la persona agresora?</label>
                    <div class="form-check">
                    ...
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="respuesta10" value="parientes colaterales de los cónyuges y convivientes hasta el cuarto grado de consanguinidad y segundo de afinidad" id="rp10_opcion11">
                    ...
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="respuesta10" value="quienes habitan en el mismo hogar, siempre que no medien relaciones contractuales o laborales" id="rp10_opcion12">
                    ...
                    <div class="form-check">
                    <input class="form-check-input" type="radio" name="respuesta10" value="quienes hayan procreado hijos en común, independientemente que convivan o no" id="rp10_opcion13">
        ...
        <div class="mb-3">
          <label class="form-label">Precise en qué lugar ocurrieron los hechos.</label>
          <div class="col-sm-10 col-lg-5">
              <div class="form-group row my-2 align-items-center">
        ...
        <div class="mb-3">
            <label class="form-label">Precise cómo ocurrieron los hechos</label>
            <div class="col-sm-10 col-lg-5">
        ...
        <div class="mb-3">
            ...
            <div class="col-sm-10 col-lg-5">
                <div class="form-text">Ejemplo: fotografías de la relación que mantuvo con el / la denunciado /a, certificado de matrimonio, certificado de nacimiento de sus hijos, u otros documentos que demuestren la relación con el denunciado. O si cuenta con documentos / foto /filmación de lo que ocurrió el día de los hechos, dicha documentación debe adjuntarse a la denuncia.</div>
